...
public class CognitoServiceTest {
    ...
    void testAuthenticate() {
        ...
        InitiateAuthResponse mockResponse = InitiateAuthResponse.builder()
                .authenticationResult(AuthenticationResultType.builder().idToken("mockIdToken").build()).build();
    ...
    void testForgotPassword() {
        ...
        ForgotPasswordResponse mockResponse = ForgotPasswordResponse.builder()
                .codeDeliveryDetails(CodeDeliveryDetailsType.builder().destination("test@example.com").build()).build();
